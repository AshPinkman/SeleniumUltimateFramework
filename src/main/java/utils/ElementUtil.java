...
public class ElementUtil {
    ...
    public void handleCalendar(String targetDate)throws ParseException {
        ...
        try {
            ...
            throw new InvalidDateException("Entered Date is invalid. Please enter a valid date");
        }
        ...
        String actualmonth = driver.findElement(By.xpath("//select[@title='Change the month']/child::option[@selected='selected']")).getText();
        String actualyear = driver.findElement(By.xpath("//select[@title='Change the year']/child::option[@selected='selected']")).getText();

        calendar.setTime(new SimpleDateFormat("MMM yyyy").parse(actualmonth.substring(0, 3) + " " + actualyear));

        int actualMonth = calendar.get(Calendar.MONTH);
        int actualYear = calendar.get(Calendar.YEAR);

        while (targetMonth < actualMonth || targetYear < actualYear) {
            driver.findElement(By.cssSelector("a[title='Show the previous month']")).click();
            actualmonth = driver.findElement(By.xpath("//select[@title='Change the month']/child::option[@selected='selected']")).getText();
            actualyear = driver.findElement(By.xpath("//select[@title='Change the year']/child::option[@selected='selected']")).getText();
            calendar.setTime(new SimpleDateFormat("MMM yyyy").parse(actualmonth.substring(0, 3) + " " + actualyear));
        ...
        while (targetMonth > actualMonth || targetYear > actualYear) {
            driver.findElement(By.cssSelector("a[title='Show the next month']")).click();
            actualmonth = driver.findElement(By.xpath("//select[@title='Change the month']/child::option[@selected='selected']")).getText();
            actualyear = driver.findElement(By.xpath("//select[@title='Change the year']/child::option[@selected='selected']")).getText();
            calendar.setTime(new SimpleDateFormat("MMM yyyy").parse(actualmonth.substring(0, 3) + " " + actualyear));
        ...
        driver.findElement(By.xpath("//div[@class='datepick-month']/table/tbody/tr/td/a[text()="+targetDay+"]")).click();
